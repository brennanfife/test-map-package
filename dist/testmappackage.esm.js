import { Box, VStack, ButtonGroup, IconButton, HStack, Text, Checkbox, Spinner, extendTheme, ChakraProvider } from '@chakra-ui/react';
import 'leaflet/dist/leaflet.css';
import { Polygon, MapContainer, TileLayer } from '@monsonjeremy/react-leaflet';
...
function CryptoVoxels() {
  ...
  var cachedOverlay = useMemo(function () {
...
var Atlas = /*#__PURE__*/function (_PureComponent) {
  ...
  _proto.render = function render() {
    ...
    return React.createElement(React.Fragment, null, React.createElement(TileMap, Object.assign({}, rest, {
...
Atlas.defaultProps = /*#__PURE__*/_extends({}, TileMap.defaultProps, {
  layers: []
...
function Controls(_ref) {
  ...
  return React.createElement(VStack, {
    ...
    borderRadius: "md",
    "aria-label": "Zoom out",
    icon: React.createElement(FiMinus, null),
    ...
    borderRadius: "md",
    "aria-label": "Zoom in",
    icon: React.createElement(FiPlus, null),
    ...
    color: "black",
    id: "for-sale"
  }, "For sale?"), React.createElement(Checkbox, {
    size: "sm",
    id: "for-sale",
    colorScheme: "purple",
    defaultChecked: true,
...
function DecentralandMap(_ref) {
  ...
  return React.createElement(Box, {
    h: "100%",
    bgColor: "black"
  }, layers ? React.createElement(Box, {
    position: "relative",
    h: "100%"
    ...
    isDraggable: true
  }), withControls && React.createElement(Controls, {
...
var customTheme = /*#__PURE__*/extendTheme({
  colors: {
    primary: '#FF6464',
    secondary: '#00A8CC',
    darkColor: '#21243D',
...
function Map(_ref) {
  ...
  return React.createElement(ChakraProvider, {
    ...
    h: "100%",
    w: "100%"
  }, world === 'decentraland' ? React.createElement(DecentralandMap, {
    withControls: withControls
  }) : world === 'the-sandbox' ? React.createElement(TheSandboxMap, null) : world === 'somnium-space' ? React.createElement(SomniumMap, null) : world === 'cryptovoxels' ? React.createElement(CryptoVoxels, null) : null));
}

export { Map };
//# sourceMappingURL=testmappackage.esm.js.map
