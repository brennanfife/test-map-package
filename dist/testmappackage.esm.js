...
import { Box, VStack, ButtonGroup, IconButton, HStack, Text, Checkbox, Spinner, Flex, extendTheme, ChakraProvider } from '@chakra-ui/react';
...
function App() {
  ...
  return React.createElement(Flex, {
    ...
    withControls: true
  }) : world === 'the-sandbox' ? React.createElement(TheSandboxMap, null) : // : world === 'somnium-space' ? (
  //   <SomniumSpace />
  // ) : world === 'cryptovoxels' ? (
  //   <Cryptovoxels />
  // )
...
ReactDOM.render(React.createElement(React.Fragment, null, React.createElement(ChakraProvider, {
  theme: customTheme
